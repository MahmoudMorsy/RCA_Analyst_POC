# RCA Analyst POC RCA Core v0.8.9 Architecture

**Status:** candidate; not frozen  
**Carried by:** RCA Analyst application v1.8.10
...
No v0.8.9 fix introduces Python natural-language interpretation or weakens frozen evidence rules.
...
RCA Core v0.8.9 is a **candidate**. Automated regressions are necessary but insufficient.

Live acceptance sequence:

1. Deploy the exact v1.8.10 package and rerun the complete regression bundle with a stable model configuration.
