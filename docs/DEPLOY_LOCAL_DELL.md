# Local Dell Deployment — v1.8.13

## Goal

Run the same Web UI + FastAPI backend + RCA Core v0.8.11 locally with LM Studio/llama.cpp/OpenAI-compatible inference.
...
The supported Dell runtime remains Python 3.9+. v1.8.13 retains the server-layer compatibility fix introduced in v1.8.5.
