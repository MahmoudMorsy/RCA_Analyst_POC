...
def test_health_config_and_frontend_load(tmp_path):
    ...
    assert health.json()["backend_version"] == "1.8.9"
    assert health.json()["core_version"] == "0.8.8"
...
def test_release_documentation_set_exists():
    ...
    required = [
        ...
        "docs/V1.8.9_RELEASE_NOTES.md", "docs/API.md", "docs/CONFIGURATION.md",
        "docs/DEPLOY_LOCAL_DELL.md", "docs/DEPLOY_RUNPOD.md", "docs/DEPLOY_HOME_AI_SERVER.md",
        "docs/DESKTOP_UI_MIGRATION_MATRIX.md", "docs/RCA_CORE_ARCHITECTURE_v0.8.8.md",
    ]
    for rel in required:
