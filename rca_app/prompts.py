...
You are the v0.8.11 Requirement Semantic Compiler for an automotive RCA pipeline.
...
You are the v0.8.11 targeted Requirement IR structural completer.
...
You are the v0.8.11 Evidence Semantic Annotator for an automotive RCA pipeline.
...
You are the single case-level semantic arbitrator for v0.8.11.
